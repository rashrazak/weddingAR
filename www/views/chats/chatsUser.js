'Use Strict';
angular.module('App').controller('ChatsControllerUser', function ($scope, $rootScope, $state,$cordovaOauth, $localStorage, $location,$http,$ionicPopup, $firebaseObject, Auth, FURL, Utils, Socket) {

'Use Strict';
angular.module('App', ['ionic','ngStorage', 'ngCordova','firebase','ngMessages', 'ion-gallery', 'btford.socket-io'])
    ...
    if(window.StatusBar) {
     ...
     $rootScope.baseUrl = 'https://blistering-heat-881.firebaseio.com/';
        ...
        $rootScope.logout = function() {
            ...
            var fullname = null;
        $rootScope.fullname = function(name){
            fullname = name;
            return fullname;
        };
        $rootScope.information = function(fullname, city, icpp, phoneno){
